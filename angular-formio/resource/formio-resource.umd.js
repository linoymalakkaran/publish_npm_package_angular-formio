(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('lodash'), require('formio-custom/formiojs'), require('rxjs'), require('@angular/router'), require('formiojs/utils/Evaluator'), require('@angular/common'), require('@angular/elements'), require('native-promise-only'), require('@angular/forms'), require('ngx-bootstrap/pagination')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'lodash', 'formio-custom/formiojs', 'rxjs', '@angular/router', 'formiojs/utils/Evaluator', '@angular/common', '@angular/elements', 'native-promise-only', '@angular/forms', 'ngx-bootstrap/pagination'], factory) :
