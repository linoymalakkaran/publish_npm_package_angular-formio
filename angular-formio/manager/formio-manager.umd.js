(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('formio-adports/formiojs'), require('lodash'), require('lodash/each'), require('lodash/intersection'), require('@angular/router'), require('rxjs'), require('formiojs/utils/Evaluator'), require('@angular/common'), require('@angular/elements'), require('ngx-bootstrap/modal'), require('@angular/forms'), require('ngx-bootstrap/pagination')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'formio-adports/formiojs', 'lodash', 'lodash/each', 'lodash/intersection', '@angular/router', 'rxjs', 'formiojs/utils/Evaluator', '@angular/common', '@angular/elements', 'ngx-bootstrap/modal', '@angular/forms', 'ngx-bootstrap/pagination'], factory) :
    ...
    var FormManagerCreateComponent = /** @class */ (function (_super) {
        __extends$8(FormManagerCreateComponent, _super);
