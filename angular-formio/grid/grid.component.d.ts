...
export declare class FormioGridComponent implements OnChanges, OnInit, AfterViewInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<FormioGridComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<FormioGridComponent, "formio-grid", never, { "footerPosition": "footerPosition"; "src": "src"; "formio": "formio"; "query": "query"; "items": "items"; "onForm": "onForm"; "refresh": "refresh"; "columns": "columns"; "gridType": "gridType"; "size": "size"; "components": "components"; "createText": "createText"; "isActionAllowed": "isActionAllowed"; }, { "select": "select"; "rowSelect": "rowSelect"; "rowAction": "rowAction"; "createItem": "createItem"; "error": "error"; }, never, never>;
}
